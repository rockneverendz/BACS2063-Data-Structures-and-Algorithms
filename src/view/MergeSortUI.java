 ...
 * @author usert
 */
public class MergeSortUI extends javax.swing.JFrame {

    /**
     * Creates new form MergeSortUI
     */
    public MergeSortUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MergeSortUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MergeSortUI().setVisible(true);
            }
        });
    }
